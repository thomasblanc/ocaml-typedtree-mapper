...
object (self)
  ...
  method pattern pat =
    {
      pat_desc = self#pattern_desc pat.pat_desc;
      pat_loc = self#location pat.pat_loc;
      pat_extra = map2 self#pat_extra self#location pat.pat_extra;
      pat_type = self#t_type_expr pat.pat_type;
      pat_env = self#env pat.pat_env;
    }
  ...
  method expression exp =
    {
      exp_desc = self#expression_desc exp.exp_desc;
      exp_loc = self#location exp.exp_loc;
      exp_extra = map2 self#exp_extra self#location exp.exp_extra;
      exp_type = self#t_type_expr exp.exp_type;
      exp_env = self#env exp.exp_env;
    }
  ...
  method class_expr cl =
    {
      cl_desc = self#class_expr_desc cl.cl_desc;
      cl_loc = self#location cl.cl_loc;
      cl_type = self#t_class_type cl.cl_type;
      cl_env = self#env cl.cl_env;
    }
  ...
  method class_structure cstr =
    {
      cstr_pat = self#pattern cstr.cstr_pat;
      cstr_fields = map self#class_field cstr.cstr_fields;
      cstr_type = self#t_class_signature cstr.cstr_type;
      cstr_meths = map_meths self#ident cstr.cstr_meths;
    }

  method class_field cf =
    {
      cf_desc = self#class_field_desc cf.cf_desc;
      cf_loc = self#location cf.cf_loc;
    }
  ...
  method module_expr mod_e =
    {
      mod_desc = self#module_expr_desc mod_e.mod_desc;
      mod_loc = self#location mod_e.mod_loc;
      mod_type = self#t_module_type mod_e.mod_type;
      mod_env = self#env mod_e.mod_env;
    }
  ...
  method structure str =
    {
      str_items = map self#structure_item str.str_items;
      str_type = self#t_signature str.str_type;
      str_final_env = self#env str.str_final_env;
    }

  method structure_item str =
    {
      str_desc = self#structure_item_desc str.str_desc;
      str_loc = self#location str.str_loc;
      str_env = self#env str.str_env;
    }
  ...
  method module_type mty =
    {
      mty_desc = self#module_type_desc mty.mty_desc;
      mty_type = self#t_module_type mty.mty_type;
      mty_env = self#env mty.mty_env;
      mty_loc = self#location mty.mty_loc;
    }
  ...
  method signature sign =
    {
      sig_items = map self#signature_item sign.sig_items;
      sig_type = self#t_signature sign.sig_type;
      sig_final_env = self#env sign.sig_final_env;
    }

  method signature_item sign =
    {
      sig_desc = self#signature_item_desc sign.sig_desc;
      sig_env = self#env sign.sig_env;
      sig_loc = self#location sign.sig_loc;
    }
  ...
  method core_type ctyp =
    {
      ctyp_desc = self#ctypdesc ctyp.ctyp_desc;
      ctyp_type = self#t_type_expr ctyp.ctyp_type;
      ctyp_env = self#env ctyp.ctyp_env;
      ctyp_loc = self#location ctyp.ctyp_loc;
    }
  ...
  method package_type pack =
    {
      pack_name = self#path pack.pack_name;
      pack_fields = map2 self#longident_loc self#core_type pack.pack_fields;
      pack_type = self#t_module_type pack.pack_type;
      pack_txt = self#longident_loc pack.pack_txt;
    }

  method core_field_type field =
    {
      field_desc = self#core_field_desc field.field_desc;
      field_loc = self#location field.field_loc;
    }
  ...
  method value_description val_d =
    {
      val_desc = self#core_type val_d.val_desc;
      val_val = self#t_value_description val_d.val_val;
      val_prim = map id val_d.val_prim;
      val_loc = self#location val_d.val_loc;
    }

  method type_declaration typ =
    { typ with
      typ_type = self#t_type_declaration typ.typ_type;
      typ_cstrs = map3 self#core_type self#core_type self#location typ.typ_cstrs;
      typ_kind = self#type_kind typ.typ_kind;
      typ_private = typ.typ_private;
      typ_manifest = map_option self#core_type typ.typ_manifest;
      typ_loc = self#location typ.typ_loc;
    }
  ...
  method exception_declaration exn_d =
    {
      exn_params = map self#core_type exn_d.exn_params;
      exn_exn = self#t_exception_declaration exn_d.exn_exn;
      exn_loc = self#location exn_d.exn_loc;
    }

  method class_type cltyp =
    {
      cltyp_desc = self#class_type_desc cltyp.cltyp_desc;
      cltyp_type = self#t_class_type cltyp.cltyp_type;
      cltyp_env = self#env cltyp.cltyp_env;
      cltyp_loc = self#location cltyp.cltyp_loc;
    }
  ...
  method class_signature csig =
    {
      csig_self = self#core_type csig.csig_self;
      csig_fields = map self#class_type_field csig.csig_fields;
      csig_type = self#t_class_signature csig.csig_type;
      csig_loc = self#location csig.csig_loc;
    }

  method class_type_field ctf =
    {
      ctf_desc = self#class_type_field_desc ctf.ctf_desc;
      ctf_loc = self#location ctf.ctf_loc;
    }
  ...
  method class_declaration cdecl =
    { cdecl with
      ci_params = (let (a,b) = cdecl.ci_params in ((map self#string_loc a), self#location b));
      ci_id_name = self#string_loc cdecl.ci_id_name;
      ci_id_class = self#ident cdecl.ci_id_class;
      ci_id_class_type = self#ident cdecl.ci_id_class_type;
      ci_id_object = self#ident cdecl.ci_id_object;
      ci_id_typesharp = self#ident cdecl.ci_id_typesharp;
      ci_expr = self#class_expr cdecl.ci_expr;
      ci_decl = self#t_class_declaration cdecl.ci_decl;
      ci_type_decl = self#t_class_type_declaration cdecl.ci_type_decl;
      ci_loc = self#location cdecl.ci_loc;
    }

  method class_description cdescr =
    { cdescr with
      ci_params = (let (a,b) = cdescr.ci_params in ((map self#string_loc a), self#location b));
      ci_id_name = self#string_loc cdescr.ci_id_name;
      ci_id_class = self#ident cdescr.ci_id_class;
      ci_id_class_type = self#ident cdescr.ci_id_class_type;
      ci_id_object = self#ident cdescr.ci_id_object;
      ci_id_typesharp = self#ident cdescr.ci_id_typesharp;
      ci_expr = self#class_type cdescr.ci_expr;
      ci_decl = self#t_class_declaration cdescr.ci_decl;
      ci_type_decl = self#t_class_type_declaration cdescr.ci_type_decl;
      ci_loc = self#location cdescr.ci_loc;
    }

  method class_type_declaration ctdecl =
    { ctdecl with
      ci_params = (let (a,b) = ctdecl.ci_params in ((map self#string_loc a), self#location b));
      ci_id_name = self#string_loc ctdecl.ci_id_name;
      ci_id_class = self#ident ctdecl.ci_id_class;
      ci_id_class_type = self#ident ctdecl.ci_id_class_type;
      ci_id_object = self#ident ctdecl.ci_id_object;
      ci_id_typesharp = self#ident ctdecl.ci_id_typesharp;
      ci_expr = self#class_type ctdecl.ci_expr;
      ci_decl = self#t_class_declaration ctdecl.ci_decl;
      ci_type_decl = self#t_class_type_declaration ctdecl.ci_type_decl;
      ci_loc = self#location ctdecl.ci_loc;
    }
  ...
  method t_value_description vd =
    {
      val_type = self#t_type_expr vd.val_type;
      val_kind = self#t_value_kind vd.val_kind;
      val_loc = self#location vd.val_loc;
    }
  method t_type_declaration td =
    { td with
      type_params = map self#t_type_expr td.type_params;
      type_kind = self#t_type_kind td.type_kind;
      type_manifest = map_option self#t_type_expr td.type_manifest;
      type_loc = self#location td.type_loc;
    }
  ...
  method t_exception_declaration ed =
    {
      exn_args = map self#t_type_expr ed.exn_args;
      exn_loc = self#location ed.exn_loc;
    }

  method t_class_type_declaration ctd =
    { ctd with
      clty_params = map self#t_type_expr ctd.clty_params;
      clty_type = self#t_class_type ctd.clty_type;
      clty_path = self#path ctd.clty_path;
    }
  ...
  method t_class_signature sgn =
    { sgn with
      cty_self = self#t_type_expr sgn.cty_self;
      cty_inher = map2 self#path (map self#t_type_expr) sgn.cty_inher
    }
  method t_class_declaration cd =
  { cd with
    cty_params = map self#t_type_expr cd.cty_params;
    cty_type = self#t_class_type cd.cty_type;
    cty_path = self#path cd.cty_path;
    cty_new = map_option self#t_type_expr cd.cty_new;
 }
  ...
  method t_row_desc row =
   { row with
     row_fields = map2 id self#t_row_field row.row_fields;
     row_more = self#t_type_expr row.row_more;
     row_name = map_option (map_tuple self#path  (map self#t_type_expr)) row.row_name;
   }
